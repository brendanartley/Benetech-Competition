from benetech_counter.train import train
import argparse
...
config = SimpleNamespace(
    ...
    model_save_dir = "/data/bartley/gpu_test/models/counters/",
    cache_dir = "/data/bartley/gpu_test/HF_CACHE",
    model_path = "google/deplot",
    processor_path = "google/deplot",
    chart_type = "s", # one of "vhlsd" (vertical_bar, horizontal_bar, line, scatter, dot)
    axis = "x", # one of "xy"
    no_wandb = False,
    project = "Benetech-Counter",
    save_model = True,
    max_patches = 1024,
    max_length = 512,
    batch_size = 3,
